...
PRODUCT_NAME_MAPPINGS = {
    # AIX Products
    # Note: app.py creates a combined 'AIX' key merging 'AIX Standard Edition' versions
    # AND manually appends 7.3.0. After lowercasing this becomes dict key 'aix'.
    # Do NOT map to 'AIX Standard Edition' — that key misses 7.3+.
    "aix": "AIX",
